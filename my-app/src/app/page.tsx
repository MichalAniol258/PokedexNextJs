...
export default function Home() {
  ...
  return (
    <>
      <div id="home" className="relative flex justify-end paddingo items-center h-screen font-semibold text-center">
        {/* Tło z rozmyciem */}
          ...
          <div className="flex gap-4 items-center justify-start">
            <Link href="/upload">
              <Button size="lg" className="background focus:ring-4 focus:ring-blue-500 focus:outline-none" radius="full">
                Open App <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
